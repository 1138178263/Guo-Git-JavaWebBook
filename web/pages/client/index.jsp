	...
	<script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				//location.href = "http://localhost:8088/01_JavaWebBook/CartServlet?action=addItem&id="+bookId;
				//发ajax请求，添加商品到购物车
				$.getJSON("http://localhost:8088/01_JavaWebBook/CartServlet","action=ajaxAddItem&id="+bookId,function (data) {
